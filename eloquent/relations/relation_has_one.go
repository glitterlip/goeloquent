...
func MatchHasOne(models interface{}, related interface{}, relation *HasOneRelation) {
	...
	selfModel := eloquent.GetParsedModel(relation.SelfModel)
	...
	isPtr := selfModel.FieldsByStructName[relation.Relation.Name].FieldType.Kind() == reflect.Ptr
	...
	modelRelationFieldIndex := selfModel.FieldsByStructName[relation.Relation.Name].Index
