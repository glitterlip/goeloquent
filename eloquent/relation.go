...
func GetMorphMap(name string) string {
	v, ok := goeloquent.Eloquent.RegisteredMorphModelsMap.Load(name)
	if !ok {
...
type Relation struct {
	...
	Builder          *Builder    // RelationBuilder
	Name             string      // field name in self model corresponding to this relation
}
type RelationI interface {
	...
	//GetKeys(models []interface{},key string) //Get all of the primary keys for an array of models.
...
func NewRelationBaseBuilder(related interface{}) *Builder {
	connectionName := goeloquent.DefaultConnectionName

	if related == nil {
		return NewBuilder(query.NewBuilder(goeloquent.Eloquent.Connection(connectionName)))
	}
	...
	return NewEloquentBuilder(related, connectionName)
}
...
*/
func (m *EloquentModel) HasMany(selfModelPointer, relatedModelPointer interface{}, selfColumn, relatedColumn string) *relations.HasManyRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.HasManyRelation{
		Relation: Relation{
...
func (m *EloquentModel) BelongsTo(selfModelPointer, relatedModelPointer interface{}, selfColumn, relatedColumn string) *relations.BelongsToRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.BelongsToRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     relatedModelPointer,
...
func (m *EloquentModel) BelongsToMany(selfModelPointer, relatedModelPointer interface{}, pivotTable, pivotSelfColumn, pivotRelatedColumn, selfModelColumn, relatedModelColumn string) *relations.BelongsToManyRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.BelongsToManyRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     relatedModelPointer,
...
func (m *EloquentModel) HasOne(selfModelPointer, relatedModelPointer interface{}, selfColumn, relatedColumn string) *relations.HasOneRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.HasOneRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     relatedModelPointer,
...
/*
MorhpTo Create a new morph to relationship instance.
*/
func (m *EloquentModel) MorphTo(selfModelPointer, selfRelatedIdColumn, selfRelatedTypeColumn, relatedModelIdColumn string) *relations.MorphToRelation {

	builder := NewRelationBaseBuilder(nil)
	relation := relations.MorphToRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     nil,
...
*/
func (m *EloquentModel) MorphOne(selfModelPointer, relatedModelPointer interface{}, selfColumn, relatedModelTypeColumn, relatedModelIdColumn string) *relations.MorphOneRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.MorphOneRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     relatedModelPointer,
	...
	selfModel := GetParsedModel(selfModelPointer)
	relation.RelatedModelTypeColumnValue = goeloquent.GetMorphMap(selfModel.Name)
...
*/
func (m *EloquentModel) MorphMany(selfModelPointer, relatedModelPointer interface{}, selfColumn, relatedModelIdColumn, relatedModelTypeColumn string) *relations.MorphManyRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.MorphManyRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     relatedModelPointer,
			RelationTypeName: RelationMorphOne,
...
*/
func (m *EloquentModel) MorphToMany(selfModelPointer, relatedModelPointer interface{}, selfColumn, relatedColumn, pivotTable, pivotSelfColumn, pivotRelatedIdColumn, pivotRelatedTypeColumn, morphType string) *relations.MorphToManyRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.MorphToManyRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     relatedModelPointer,
	...
	b.Select(fmt.Sprintf("%s.%s as %s%s", relation.PivotTable, relation.PivotSelfColumn, OrmPivotAlias, relation.PivotSelfColumn))
	modelMorphName := goeloquent.GetMorphMap(selfModel.Name)
...
*/
func (m *EloquentModel) MorphByMany(selfModelPointer, relatedModelPointer interface{}, pivotTable, selfColumn, relatedIdColumn, pivotSelfColumn, pivotRelatedIdColumn, pivotRelatedTypeColumn string) *relations.MorphByManyRelation {
	b := NewRelationBaseBuilder(relatedModelPointer)
	relation := relations.MorphByManyRelation{
		Relation: Relation{
			SelfModel:        selfModelPointer,
			RelatedModel:     relatedModelPointer,
